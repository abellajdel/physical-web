...
public class MetadataResolver {
  ...
  static NearbyDeviceAdapter mAdapter;
  ...
  public static void getBatchMetadata(ArrayList<NearbyDevice> mDeviceBatchList, NearbyDeviceAdapter _mAdapter) {
    if (!mIsInitialized) {
      Log.e(TAG, "Not initialized.");
      return;
    }
        ...
        new Response.Listener<JSONObject>() {
          ...
          public void onResponse(JSONObject jsonResponse) {
            ...
            try {
              ...
              //We make the call here if the adapter is not null (App running) to refresh the UI
              if (mAdapter != null) {
